...
/*
First, we need to create an abstract class called Monoid, declaring the virtual methods that every monoid  represents in Graph Theoretic form.
 It is done this way because, no matter how the vertices and edges are represented internally, 
the pathfinding algorithms remain high-level, thus avoiding the implementation of the algorithms for each type of graph representation.
*/


public abstract class Monoid : MonoBehaviour {

	public GameObject vertexPrefab;
	protected List<Vertex> vertices;
	protected List<List<Vertex>> neighbours;
	protected List<List<float>>  const;
	protected Dictionary<int, int> instIdToId; //Aux

	//This is for informed search, a bit like A*
	public delegate float Heuristic(Vertex a, Vertex b);

	//Used for getting path in frames.
	public List<Vertex>path;
	public bool isFinished; //flag
